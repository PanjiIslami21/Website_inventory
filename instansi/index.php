      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index.php?p=material&id_jenis=2" ><i class="fa fa-circle-o"></i>ALAT KEBERSIHAN</a></li>
            <li><a href="index.php?p=material&id_jenis=3" ><i class="fa fa-circle-o"></i>PERLENGKAPAN LAIINYA</a></li>
          </ul>
        </li>
