		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
			         <p>1. Intansi menginput data permintaan barang di form permintaan barang.</p>
            <p>2. Instansi permintaan di konfirmasi oleh Bendahara.</p>
            <p>3. Setelah di konfirmasi, kemudian Instansi mencetak Bukti Permintaan Barang dan kemudian membawa Bukti yang telah di sah kan oleh Kepala Intansi Dan Ke aAdmin Bagian Pengadaan untuk dilakukan proses pengeluaran barang.</p>
				</div>
				<!-- footer modal -->
